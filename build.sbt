...
lazy val gigahorse =
  (project in file("gigahorse"))
    .settings(
      scalaVersion := scalaV,
      libraryDependencies ++= Seq(
        "com.eed3si9n" %% "gigahorse-core" % "0.4.0",
        "com.eed3si9n" %% "gigahorse-asynchttpclient" % "0.4.0"
      )
    )
  ...
  (project in file("hammock"))
    .settings(
      ...
      libraryDependencies ++= Seq(
        ...
        "com.pepegar" %% "hammock-apache-http" % "0.9.1",
        "com.pepegar" %% "hammock-circe" % "0.9.1"
      )
    )
